...
class SecurityAgent:
    ...
    def run(
        ...
        if self.mode == "openai":
            return self._run_openai(requirements, architecture)
        return self._run_stub(requirements, architecture)
    ...
    def _run_stub(
        ...
        threat_model = ThreatModel(
            ...
            threats=[
                ...
                Threat(
                    ...
                    mitigation="Restrict write permissions and preserve append-only audit semantics.",
                ),
                Threat(
                    ...
                    mitigation="Redact secrets and minimize sensitive data sent to external providers.",
                ),
            ],
            controls=[
                "input validation",
        ...
        findings = [
            SecurityFinding(
                ...
                description=(
                    "The current alpha exposes task endpoints without an "
                ...
                threat="Spoofing",
                recommendation=(
                    "Introduce authenticated principals and authorization "
                    "before non-local or production exposure."
                ),
            ...
            SecurityFinding(
                ...
                description=(
                    "Audit events are recorded, but append-only semantics are "
                    "not enforced by dedicated database privileges."
                ),
                ...
                threat="Tampering",
                recommendation=(
                    "Use restricted roles or append-only storage controls for "
                    "audit events in a later hardening release."
                ),
        ...
        review = SecurityReviewResult(
            ...
            summary=(
                "The architecture has basic engineering controls, but the "
                "absence of API authentication is a high-severity blocker for "
                "production exposure."
            ),
        )
